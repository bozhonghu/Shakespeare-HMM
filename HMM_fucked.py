...
class HiddenMarkovModel:
    ...
    def unsupervised_learning(self, X, N_iters):
        ...
        for iteration in range(1, N_iters + 1):
            ...
            for curr in range(self.L - 1):
                for nxt in range(self.L - 1):
                    self.A[curr][nxt] = A_num[curr][nxt] / A_den[curr]

            for curr in range(self.L - 1):
                for xt in range(self.D - 1):
    ...
    def generate_emission(self, M):
        ...
        emission = []
        state = random.choice(range(self.L - 1))
        states = []
        ...
        for t in range(M):
            ...
            while rand_var > 0:
                rand_var -= self.O[state][next_obs] / sum(self.O[state])
                next_obs += 1
            ...
            while rand_var > 0:
                rand_var -= self.A[state][next_state] / sum(self.A[state])
                next_state += 1
